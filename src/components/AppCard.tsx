...
export const AppCard = ({ name, description, image, link }: AppCardProps) => {
  ...
  return (
    <div 
      onClick={handleClick}
      className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 overflow-hidden cursor-pointer transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] hover:bg-white/90 group"
    >
      <div className="flex">
        {/* Image Section */}
        ...
        <div className="flex-1 p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-start justify-between mb-2">
              ...
              <ExternalLink 
                className="w-5 h-5 text-gray-400 group-hover:text-blue-600 transition-colors duration-300 flex-shrink-0 ml-2" 
              />
            </div>
